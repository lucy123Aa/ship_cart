...
import { refundPolicy } from "@/constants/static/refundPolicy";
      ...
      <SafeAreaView style={{ flex: 1 }}>
        ...
        >
          ...
          <View style={styles.container}>
            <Text style={[styles.des, { marginVertical: 10 }]}>
              Our goal is to ensure you are completely satisfied with your
              purchase. If you are not satisfied, you may be eligible to return
              the item for a refund. This policy outlines the conditions and
...
const styles = StyleSheet.create({
  ...
  des: { fontSize: 16, fontWeight: "light" },
  pointRow: {
    flexDirection: "row",
